    ...
    <div class="portlet">
          <div id="portlet2" class="panel-collapse collapse in">
            <div class="portlet-body">
                <form method="get" action="<?php echo base_url('laporan/top_customer_presensce'); ?>" id="formTopCustomerPresence">
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-12 text-right">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        <li><a href="#" class="topcust-pres-csv" data-delim=",">Delimiter: koma (,)</a></li>
                        <li><a href="#" class="topcust-pres-csv" data-delim=";">Delimiter: titik koma (;)</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="row" style="margin-top: 24px;">
                  <div class="col-md-12">
                    ...
                    <h4 style="text-align: center;">Berdasarkan Kedatangan Customer</h4>
                      ...
                      <tr style="background: #2A303A;color:white;font-weight: bold;">
                       ...
                       <tr>
                        ...
                        <td align="right"><?php echo number_format($row->poin_value,'0',',','.'); ?></td>
                         ...
                         <td align="center"><?php echo number_format($row->presence,'0',',','.'); ?></td>
                         <td align="center"><?php echo $row->last_transaction; ?></td>
                       </tr>
                       <?php $i++; } ?>
                    </table>
                  </div>
...
<script type="text/javascript">window._topCustPresCsvBase='<?php echo base_url('laporan/export_csv_top_customer_presence'); ?>';</script>
