...
<div class="wraper container-fluid">
    <div class="portlet"><!-- /primary heading -->
        <div id="portlet2" class="panel-collapse collapse in">
            <div class="portlet-body" style="background:#FDFDFD">
                    ...
                    <div class="row" style="margin-top: 5px;">
                		...
                		<div class="col-md-3" style="padding-right: 15px;">
                			<div class="row">
                				<div class="col-md-12" style="border-right:solid 0.1px #ccc;border-bottom: solid 0.1px #ccc;border-top: solid 2px #ccc;background:#fbede8;padding-top:4px;border-bottom-left-radius:9px">
                        ...
                        <div class="col-md-9">                			
                            <div class="row">
                                <div class="col-md-12" style="border-right:solid 0.1px #ccc;border-left:solid 0.1px #ccc;">
                                    <div class="form-group">
                        				<input type="hidden" id="produk-ajax" name="customer" style="width: 100%;">
                        			</div>

                        			<div class="form-group" style="margin-top: 20px;height: 320px;" id="tableNiceScroll">
                        				<?php
                                            if(empty($idStore)){
                                        ...
                                        <table class="table table-striped table-bordered" style="font-size: 12px;">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="7" id="totalQty" align="right" style="font-weight: bold;"></td>
                                                </tr>
                                            </tfoot>
                        				</table>
                                        <?php } ?>
                        ...
                        <div class="col-md-12" style="border: 1px solid #ccc;padding-left:10px;background:#d00d51;border-radius:9px;position:absolute;z-index:100;bottom:0;width:90%;right:5%">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Diskon" id="diskon" value="<?php if($diskonPromosi > 0){echo $diskonPromosi;}?>" style="text-align: right;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Total Qty" id="totalQty" style="font-size:20px;text-align:right;font-weight:bold" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                            <input type="text" class="form-control" placeholder="Jumlah Bayar" id="jumlah_bayar" name="jumlah_bayar" style="font-size:25px;text-align:right;font-weight:bold" required>
                                        </div>
                                    </div>
                                </div>
