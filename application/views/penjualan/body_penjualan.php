...
<div id="payment_total_notif" style="width: 450px;position: fixed;z-index: 1;left: 8px;top:8px;display: none;background: #FFF" >
                		...
                		<div class="col-md-9">                			
                            <div class="row">
                                <div class="col-md-12">
                        			...
                        			<div class="form-group" style="margin-top: 20px;height: 450px;" id="tableNiceScroll">
                        				<?php
                                            if(empty($idStore)){
                                        ...
                                        <table class="table table-striped table-bordered" style="font-size: 12px;">
                        					<thead>
            	            					<tr style="background: #f3a1a5;color:white;font-weight: bold;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><a href="#customerModalx" data-toggle="modal"><i class="fa fa-user-plus" style="color:#007223;"></i></a></span>
...
-->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Jumlah Bayar" id="jumlah_bayar" name="jumlah_bayar" style="font-size:18px;" required>
                                        </div>
                                    </div>
...
<div id="customerModalx" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
