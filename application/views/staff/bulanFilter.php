...
<script type="text/javascript">
    ...
    $('#viewByMonth').on("click",function(){
    	...
    	var urlSalesPerSubkategori = "<?php echo base_url('dashboard/subkategoriSalesMonth'); ?>";
		...
		var urlFastMoving = "<?php echo base_url('dashboard/fastMovingMonth'); ?>";
        var urlSlowMoving = "<?php echo base_url('dashboard/slowMovingMonth'); ?>";
		var urlBrand1 = "<?php echo base_url('dashboard/salesPerBrand1Month'); ?>";
        var urlBrand2 = "<?php echo base_url('dashboard/salesPerBrand2Month'); ?>";
