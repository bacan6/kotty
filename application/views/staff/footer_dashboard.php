 <!-- Page Content Ends -->
    	...
    	<script type="text/javascript">
            ...
            var urlSalesPerSubkategori = "<?php echo base_url('dashboard/subkategoriSales'); ?>";
            ...
            var urlTebusMurah = "<?php echo base_url('dashboard/tebusMurah'); ?>";
            ...
            $(document).ready(function(){
                ...
                $('#salesPerHour').load(urlSalesPerHour,{tanggal : ""});
                $('#salesPerkategori').load(urlSalesPerkategori,{tanggal : ""});
                $('#salesPerKasir').load(urlSalesPerkasir,{tanggal : ""});
                $('#salesPerSubkategori').load(urlSalesPerSubkategori,{tanggal : ""});
                $('#topProdukByKategoriWidget').load(urlTopProdukByKategoriWidget,{tanggal : ""});
                $('#topProdukBySubkategoriWidget').load(urlTopProdukBySubkategoriWidget,{tanggal : ""});
