 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            function submitPO(){
                ...
                if(tanggalMulai=='' || tanggalSelesai=='' || (($('#setJam').is(":checked")) && (jamMulai=='' || jamSelesai==''))){
                    if(tanggalMulai==''){
                    ...
                    $.ajax({
                                method      : "POST",
                                url         : urlInsertPO,
                                data        : {tipe:tipe,store:store,tanggalMulai : tanggalMulai, tanggalSelesai : tanggalSelesai, keterangan : keterangan, jamMulai : jamMulai, jamSelesai : jamSelesai, setJam : setJam,setHari : setHari,HariID : HariID},
                                beforeSend  : function(){
