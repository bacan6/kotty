                    ...
                    <div class="col-md-12" id="area-print" style="padding:5px;font-size: 13px;">
                        ...
                        <table style="margin-top: 5px;width: 100%;border:solid 1px black;font-size: 12px;">
                            <tr style="font-weight: bold;border-bottom: solid 1px black;">
                                ...
                                <td style="text-align: center;border-right: solid 1px black;">Qty Berbayar</td>
                                <td style="text-align: center;border-right: solid 1px black;">Qty Gratis</td>
                                <td style="text-align: center;border-right: solid 1px black;">Nilai Diskon</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;border-right: solid 1px black;border-top: solid 1px black;"><?php echo number_format($row->minimal_belanja,'0',',','.'); ?></td>
                                <td style="text-align: center;border-right: solid 1px black;border-top: solid 1px black;"><?php echo $row->paid_item; ?> </td>
                                <td style="text-align: center;border-right: solid 1px black;border-top: solid 1px black;"><?php echo $row->free_item; ?> </td>
