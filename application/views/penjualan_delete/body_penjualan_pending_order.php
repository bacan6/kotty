                ...
                <form id="submit-penjualan" method="post">	
                    <div class="row">
                        <div class="col-md-12" align="right">
                            <a href="<?php echo base_url('penjualankasir/data_penjualan'); ?>"> <i class="fa fa-book"></i> Data Penjualan </a> | <a href="<?php echo base_url('penjualankasir/reservasi'); ?>"> <i class="fa fa-history"></i> Reservasi </a> | | <a href="<?php echo base_url('penjualankasir/daftar_tunggu'); ?>"> <i class="fa fa-clock-o"></i> Daftar Pending </a>
                        </div>

                        <div class="col-md-12" style="text-align: right;margin-top: 30px;">
                            <button id="button-submit" type="submit" class="btn btn-icon btn-primary m-b-5" onclick="submitForm('<?php echo base_url('penjualankasir/penjualan_sql'); ?>')"> <i class=" fa fa-check-square-o"></i> Submit</button>

                            <button type="submit" class="btn btn-icon btn-primary m-b-5" onclick="submitForm('<?php echo base_url('penjualankasir/penjualan_tunggu_sql'); ?>')"> <i class=" fa fa-clock-o"></i> Tunggu</button>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        ...
        /* ==============================================
                ...
                $('#profil-address').on("click",function(){
                    ...
                    if($(this).is(':checked') ) {
                        ...
                        if(customer_form!=''){
                            //BACA DATA ALAMAT
                           /**$.ajax({
                                        url      : "<?php echo base_url('penjualankasir/get_alamat_customer'); ?>",
                            ...
                            url = "<?php echo base_url('penjualankasir/use_profil_address'); ?>";
            ...
            $('#produk-ajax').change(function(){
               data_form = "<?php echo base_url('penjualankasir/data_form'); ?>";
               sku = $('#produk-ajax').val();
               no     = parseInt($('#sdf').val());
               urutan = no+1; 
                                               ...
                                               <script type="text/javascript">
                                                        ...
                                                        $('.qty_beli<?php echo $xo; ?>').on("change",function(){
                                                           ...
                                                           $("input[class *= 'total_beli_hidden']").each(function(){
                                                            ...
                                                            $.ajax({
                                                                    type    : "POST",
                                                                    url     : "<?php echo base_url('penjualankasir/cek_diskon'); ?>",
                                                                    data    : {sku : sku},
                                                                    success : function(result){
                                                                                if(result==1){
                                                                                    $.ajax({
                                                                                        type    : "POST",
                                                                                        url     : "<?php echo base_url('penjualankasir/ambil_nilai_diskon'); ?>",
