...
<script type="text/javascript">
	...
	$('.jumlahBeli').on("change",function(){
        ...
        var urlCekStok = "<?php echo base_url('penjualankasir/cekStokPerStore'); ?>";
	...
	$('.changeDiskon').on("change",function(){
		...
		var updateDiskon = "<?php echo base_url('penjualankasir/updateDiskonPending'); ?>";
	...
	$('.hapusCart').on("click",function(){
		...
		var urlHapus 	 = "<?php echo base_url('penjualankasir/hapusCart'); ?>";
    ...
    function updateQtyCart(idProduk,qty,id){
        var urlUpdate = "<?php echo base_url('penjualankasir/updateQtyCartPending'); ?>";
