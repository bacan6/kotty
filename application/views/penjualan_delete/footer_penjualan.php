        ...
        <script type="text/javascript">
            var totalPurchaseUrl = "<?php echo base_url('penjualankasir/totalPurchase'); ?>";
            var diskonPeritemUrl = "<?php echo base_url('penjualankasir/diskonPeritemPanel'); ?>";
            var urlDiskonDisplay = "<?php echo base_url('penjualankasir/diskonMemberDisplay'); ?>";
            var urlMemberPoin    = "<?php echo base_url('penjualankasir/data_customer_poin'); ?>";
            var urlNilaiReimburs = "<?php echo base_url('penjualankasir/viewNilaiReimburs'); ?>";
            var urlViewOngkir = "<?php echo base_url('penjualankasir/viewOngkir'); ?>";
            var urlViewDiskon = "<?php echo base_url('penjualankasir/viewDiskon'); ?>";
            var urlGrandTotal = "<?php echo base_url('penjualankasir/viewGrandTotal'); ?>";
            ...
            jQuery(document).ready(function($) {
                ...
                var dataUrl = "<?php echo base_url('penjualankasir/viewCart'); ?>";
           ...
           $("#tableNiceScroll").niceScroll();
            ...
            $(document).scannerDetection(function(val){
                var sku = val;
                //get data produk
                urlProduk = "<?php echo base_url('penjualankasir/getDataProduk'); ?>"; 
                ...
                $.ajax({
                            ...
                            success  : function(response){
                                        $.each(response, function(x,obj){
                                            ...
                                            if(parseInt(stok) > 0){
                                                var urlCart = "<?php echo base_url('penjualankasir/insertCart'); ?>";
            ...
            $('#provinsi').change(function(){
                url = "<?php echo base_url('penjualankasir/list_kabupaten'); ?>";
            ...
            $('#list-kabupaten').change(function(){
                url= "<?php echo base_url('penjualankasir/list_kecamatan'); ?>";
            ...
            $('#customer-form').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('penjualankasir/ajax_customer'); ?>',
                    dataType    : 'json',
                    quietMillis : 100,
                    method      : "GET",
            ...
            $('#produk-ajax').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('penjualankasir/ajax_produk'); ?>',
                    dataType    : 'json',
                    quietMillis : 500,
                    method      : "GET",
                    data: function (params) {
            ...
            $('#ongkir').on("keyup",function(){
                var ongkir = $(this).val();
                var urlOngkir = "<?php echo base_url('penjualankasir/insertOngkir'); ?>";
            ...
            $('#diskon').on("keyup",function(){
                ...
                var urlDiskon   = "<?php echo base_url('penjualankasir/insertDiskon'); ?>";
            ...
            $(document).on("change","#customer-form",function(){
                ...
                $.ajax({
                            type    : 'POST',
                            url     : "<?php echo base_url('penjualankasir/get_diskon_customer'); ?>",
                            data    : {id : id_customer},
            ...
            function displayDiskonMember(diskon,id_customer){
                $.ajax({
                            ...
                            success : function(totalPurchase){  
                                        ...
                                        //simpan di database
                                        var urlDiskon = "<?php echo base_url('penjualankasir/saveDiskonMember'); ?>";
            ...
            $('#customer-form').change(function(){
                ...
                url = "<?php echo base_url('penjualankasir/data_customer_poin'); ?>";
            ...
            $('#type_bayar').change(function(){
                ...
                sub_account = "<?php echo base_url('penjualankasir/sub_account'); ?>";
                tempo_form  = "<?php echo base_url('penjualankasir/tempo_form'); ?>";
            ...
            $('#pendingTrx').on("click",function(){
                $.ajax({
                            method : "POST",
                            url : "<?php echo base_url('penjualankasir/pendingTrx'); ?>",
                            beforeSend : function(){
                                            $('#CssLoader').show();
                                         },
                            success : function(){
            ...
            function submitPenjualan(){
                var urlTotalKeseluruhan = "<?php echo base_url('penjualankasir/totalKeseluruhan'); ?>";

                $.ajax({
                            type        : "POST",
                            url         : urlTotalKeseluruhan,
                            success     : function(totalPurchase){
                                            if(jumlah_bayar < totalPurchase || jumlah_bayar==''){
            ...
            function prosesPenjualan(){
                ...
                var urlPenjualan = "<?php echo base_url('penjualankasir/penjualan_sql'); ?>";
                ...
                $.ajax({
                            ...
                            success : function(noInv){
                                            var urlRedirect = "<?php echo base_url('penjualankasir/invoice_penjualan?no_invoice='); ?>"+noInv;
            ...
            $('#noMember').change(function(){
                ...
                var url = "<?php echo base_url('penjualankasir/cekNoMemberIfDuplicate'); ?>";
            ...
            $('#simpanMember').on("click",function(){
                ...
                var url = "<?php echo base_url('penjualankasir/simpanMember'); ?>";
            ...
            $('#alamatCustomer').on("click",function(){
                ...
                if($('#alamatCustomer').is(":checked")){
                    ...
                    if(idCustomer==''){
                        ...
                        var urlCustomer = "<?php echo base_url('penjualankasir/viewAlamatCustomer'); ?>";
                    ...
                    var emptyAlamatCust = "<?php echo base_url('penjualankasir/emptyAlamatCust'); ?>";
