...
class Expired_product extends BaseController{
	function __construct(){
		...
		$this->load->model(array("model1","modelExpired"));
		$this->load->database();
	...
	function index(){
		$this->global['pageTitle'] = "Solusinformatika.com - Expired Product";
	...
	function daftar_po(){
		$this->global['pageTitle'] = "Solusinformatika.com - Daftar Produk Kadaluarsa";
		$this->global['navigation'] = $this->model1->callNavigation();
	...
	function form_po(){
		...
		$this->global['pageTitle'] = "Solusinformatika.com - Form Produk Kadaluarsa";
		$this->global['navigation'] = $this->model1->callNavigation();
	...
	function datatablesPO(){
		...
		foreach ($query->result_array() as $dt) {
			...
			$output['data'][]=array($nomor_urut,"<a href='".base_url('expired_product/form_po?no_po='.$dt['no_po'])."'>".$dt['no_po']."</a>",$dt['tanggal_po'],$dt['first_name'],$dt['store'],$button);
			$nomor_urut++;
		}
