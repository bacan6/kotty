        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function(e) {
                ...
                $('#brand').change(function(){
                	...
                	$.ajax({
                                method      : "POST",
                                url         : '<?php echo base_url('purchase_order/ajax_produk_supplier'); ?>',
                                data        : {brand : brand,id_toko:id_toko},
            ...
            $('#sku').change(function(){
               ...
               $.ajax({
                            method      : 'POST',
                            url         : urlInsertCartPo,
                            data        : {idProduk : idProduk,id_toko:id_toko},
            ...
            function submitPO(){
                ...
                if(jatuhTempo=='' || tanggalKirim=='' || supplier=='' || id_toko==''){
                    if(id_toko==''){
                        $.Notification.notify('error', 'top right', 'Pilihan Toko', 'Harap Isi Pilihan Toko');
                    } 
                    if(jatuhTempo==''){
                    ...
                    $.ajax({
                                method      : "POST",
                                url         : urlInsertPO,
                                data        : {id_toko:id_toko, jatuhTempo : jatuhTempo, tanggalKirim : tanggalKirim, supplier : supplier, keterangan : keterangan,alamatPengiriman : alamatPengiriman},
                                beforeSend  : function(){
