            	...
            	<div class="row">
	                <div class="col-md-12" style="text-align: right;">
	                    ...
	                    <?php
                        	...
                        	if($status_po < 1){
                        ?>
	                    <a onclick="return confirm('Are You Sure ?')" href="<?php echo base_url('purchase_request/change_po_status?status=4'.'&no_po='.$_GET['no_po']); ?>" class="btn btn-success"><i class="fa fa-check"></i> Accept </a>
                            ...
                            <tr>
                                <td width="50%">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td style="font-weight:  bold;width: 15%;">Store</td>
                                            <td style="width: 3%;">:</td>
                                            <td><b><?php echo $noteInfo->store; ?></b></td>
                                        </tr>
                                        <tr>
                        ...
                        <table class="table table-bordered" style="margin-top: 20px;font-size:12px;">
                            <thead>
                                <tr style="font-weight: bold;">
                                    ...
                                    <td width="5%">Qty (Last Receive)</td>
                                    <td width="5%">Sales &raquo; 31days</td>
                                    <td width="5%" align="center">Stok</td>
                                    <td width="5%" style="text-align: center;">Qty Req</td>
                                    <td width="5%" align="center">Bonus</td>
                                    <td width="5%" style="text-align: center;">Qty Disetujui</td>
