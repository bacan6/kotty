            ...
            <div class="portlet-body">
                <div class="row">
                    <div class="col-md-12" style="text-align: right;">
                        ...
                        <a class="btn btn-success" href='<?php echo base_url('purchase_order/form_po?no_po='.$_GET['no_po'])?>'>Form Purchase Order (Disetujui)</a>
                    ...
                    <div class="col-md-12" id="area-print" style="padding:5px;font-size: 13px;">
                        ...
                        <table style="margin-top: 5px;width: 100%;border:solid 1px black;font-size: 12px;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;border-right: solid 1px black;"><?php echo $row->qty_req; ?></td>
