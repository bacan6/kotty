<div class="wraper container-fluid">
    <div class="page-title"> 
      <h3 class="title"><i class="fa fa-hand-o-down"></i> Purchase Requests</h3> 
    </div>
                        ...
                        <table class="table table-bordered" style="font-size:12px;" id="datatable">  
                           <thead>
                               <tr style="font-weight: bold;">
                                    ...
                                    <td style="text-align: center;vertical-align: middle;">Cabang</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Filter Purchase Requests</h4>
            </div>
