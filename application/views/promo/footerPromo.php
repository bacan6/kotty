<!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            var promo        = "<?php echo base_url('promo/data_promo'); ?>";
          ...
          $('#submit').submit(function(e){
              e.preventDefault();
                ...
                url = "<?php echo base_url('promo/add_promo_sql'); ?>";
           ...
           $('#brand').select2({
                placeholder: "Pilih Data Brand",
                ajax: {
                    url         : '<?php echo base_url('promo/ajax_brand'); ?>',
                    dataType    : 'json',
                    quietMillis : 100,
                    method      : "GET",
