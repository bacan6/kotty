<div class="wraper container-fluid">
    <div class="page-title"> 
      <h3 class="title">Mass Update Nama Produk</h3> 
    </div>
                        ...
                        <div class="row" style="padding: 10px;">
                            <div class="col-md-6">
                                <div style="border:solid 1px #ddd;min-height: 100px;border-radius: 5px;vertical-align: middle;padding: 5px;">
                                    ...
                                    <a style="font-weight: bold;font-size: 12px;color: orange;" href="<?php echo base_url('produk/templateUpdateNama'); ?>">Download Template</a> <br>
                                </div>
                            </div>
