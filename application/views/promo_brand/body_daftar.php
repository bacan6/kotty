<div class="wraper container-fluid">
    <div class="page-title"> 
      <h3 class="title">Daftar Promo Khusus Brand</h3> 
    </div>
                        ...
                        <table class="table table-bordered" style="font-size:12px;" id="datatable">  
                           <thead>
                               <tr style="font-weight: bold;">
                                    ...
                                    <td style="text-align: center;vertical-align: middle;">Brand</td>
                                    <td style="text-align: center;vertical-align: middle;">Tipe Promo</td>
                                    <td style="text-align: center;vertical-align: middle;">Minimal</td>
                                    <td style="text-align: center;vertical-align: middle;">Diskon</td>
