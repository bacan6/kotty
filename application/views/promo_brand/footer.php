        ...
        <script type="text/javascript">
            ...
            function submitPO(){
                ...
                if(jamMulai=='' || jamSelesai=='' || setJam=='' || tanggalMulai=='' || tanggalSelesai=='' || toko=='' || brand=='' || (($('#setJam').is(":checked")) && (jamMulai=='' || jamSelesai==''))){
                    ...
                    if(rules_type==''){
                        $.Notification.notify('error', 'top right', 'Tipe Promo', 'Harap Pilih Tipe Promo');
                    }
                    if(minBelanja==''){
                        $.Notification.notify('error', 'top right', 'Minimal Belanja', 'Harap Pilih Minimal Belanja');
                    }
                    if(discount==''){
                        $.Notification.notify('error', 'top right','Diskon', 'Harap Pilih Diskon');
                    }
                    ...
                    $.ajax({
                                method      : "POST",
                                url         : urlInsertPO,
                                data        : {rules_type:rules_type,discount:discount, minBelanja:minBelanja,tanggalMulai : tanggalMulai, tanggalSelesai : tanggalSelesai, brand : brand, toko : toko, keterangan : keterangan, jamMulai : jamMulai, jamSelesai : jamSelesai, setJam : setJam,setHari : setHari,HariID : HariID},
                                beforeSend  : function(){
