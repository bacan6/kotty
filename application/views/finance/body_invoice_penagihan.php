               ...
               <div class="row" style="margin-top: 20px;">
                      ...
                      <thead>
                          ...
                          <td align="center">Sisa</td>
                           ...
                           <td align="right">Dis1</td>
                           <td align="right">Dis2</td>
                           <td align="right">Dis3</td>
                  ...
                  <div class="col-md-6">
                    ...
                    <table width="100%">
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td><?php echo $supplier->termOfPay; ?></td>
                      </tr>
                      <tr>
                        <td>Jenis Bayar</td>
                        <td>:</td>
                        <td><?php echo $supplier->jenisBayar; ?></td>
                      </tr>
                      <tr>
                        <td>PKP</td>
                        <td>:</td>
                        <td><?php echo $supplier->jenisPKP; ?></td>
                      </tr>
                      <tr>
                        <td>Terima Retur</td>
                        <td>:</td>
                        <td><?php echo $supplier->jenisRetur; ?></td>
                      </tr>
                    </table>
                  </div>
               </div>
