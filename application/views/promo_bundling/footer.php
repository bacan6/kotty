 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            var urlCartPO = "<?php echo base_url('promo_bundling/cartPO'); ?>";
            ...
            $('#sku').change(function(){
               ...
               var urlInsertCartPo = "<?php echo base_url('promo_bundling/insertCartPO'); ?>";
            ...
            function submitPO(){
                ...
                var urlInsertPO = "<?php echo base_url('promo_bundling/insertPO'); ?>";
                ...
                if(tanggalMulai=='' || tanggalSelesai==''){
                    ...
                    $.ajax({
                                method      : "POST",
                                url         : urlInsertPO,
                                data        : {diskon:diskon,store:store,tanggalMulai : tanggalMulai, tanggalSelesai : tanggalSelesai, keterangan : keterangan, jamMulai : jamMulai, jamSelesai : jamSelesai, setJam : setJam,setHari : setHari,HariID : HariID},
                                beforeSend  : function(){
                                                $('#prosesPO').text('Harap Tunggu...');
                                                $('#CssLoader').show(); 
                                              },
                                success     : function(noInv){
                                                window.location.replace("<?php echo base_url('promo_bundling/form_promo?no_promo='); ?>"+noInv);
                                              }
                    });
                }
            }
            ...
            $('#sku').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('promo_bundling/ajax_produk'); ?>',
                    dataType    : 'json',
                    quietMillis : 100,
                    method      : "GET",
