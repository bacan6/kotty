 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            $('#filterDataStok').on("click",function(){
                ...
                var stokMinim = $('#stokMinim').val();

                var urlButtonXLS = "<?php echo base_url('data_stok_toko/exportExcelTokoFilter');?>";
                var urlButtonPDF = "<?php echo base_url('data_stok_toko/exportPdfTokoFilter');?>";
                ...
                $.ajax({
                            ...
                            success     : function(response){
                                            ...
                                            subkategori = subkategori==undefined ? '':subkategori;
                                            subSubKategori = subSubKategori==undefined ? '':subSubKategori;

                                            $('#buttonExport').html('<a href="'+urlButtonXLS+'?idBrand='+idBrand+'&idSupplier='+idSupplier+'&idKategori='+idKategori+'&subkategori='+subkategori+'&subSubKategori='+subSubKategori+'&stokSign='+stokSign+'&stokValue='+stokValue+'&priceSign='+priceSign+'&priceSignValue='+priceSignValue+'&salePriceSign='+salePriceSign+'&salePriceValue='+salePriceValue+'&idStand='+idStand+'&idToko='+idToko+'" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export Excel</a>');
                                            $('#buttonExport').append(' <a href="'+urlButtonPDF+'?idBrand='+idBrand+'&idSupplier='+idSupplier+'&idKategori='+idKategori+'&subkategori='+subkategori+'&subSubKategori='+subSubKategori+'&stokSign='+stokSign+'&stokValue='+stokValue+'&priceSign='+priceSign+'&priceSignValue='+priceSignValue+'&salePriceSign='+salePriceSign+'&salePriceValue='+salePriceValue+'&idStand='+idStand+'&idToko='+idToko+'" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Export PDF</a>');
                                          }
                });
            });
       	</script>
