<div class="wraper container-fluid">
    <div class="page-title"> 
      <h3 class="title">Data Stok Finish Goods Gudang</h3> 
    </div>
            ...
            <div class="portlet-body">
            	<div class="row">
                    ...
                    <div class="col-md-6" style="text-align: right;" id="buttonExport">
                        ...
                        <a href="<?php echo base_url('data_stok/exportPdf'); ?>" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Export Pdf</a>
                    </div>
                </div>
