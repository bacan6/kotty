		            ...
		            <div class="portlet-body">
						...
						<div class="row" style="margin-top: 20px;">
							<div class="col-md-12" style="padding: 30px;" id="content">
								...
								<table class="table table-bordered" style="font-size: 12px;" id="tableStok">
									<thead>
										<tr style="font-weight: bold;">
                                            ...
                                            <td>Margin</td>
                                            <td>Stok<br>Awal</td>
                                            <td>Barang<br>Masuk</td>
                                            <td>Barang<br>Keluar</td>
											<td>Stok Akhir</td>
                                            <td>HPPxStok</td>
										</tr>
									</thead>
                                ...
                                Harga Modal <u>Rp <?php echo number_format($nilai_toko[0]['nilai'],'2',',','.');?></u><br>
                                Harga Jual <u><?php echo number_format($nilai_toko[0]['nilaiJual'],'2',',','.');?></u></small></h3>
							</div>
						</div>	       
		            </div>
		        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                                   
                ...
                <div class="form-group">
                    ...
                    <select style="border:0;border-bottom: solid 0.5px #ccc;width: 100%;" id="idSupplier" name="idSupplier">
                        <option value="">--Pilih Supplier--</option>
                        <?php 
                            foreach($show_supplier as $sp){
                        ?>
                ...
                <div class="form-group">
                    <label>Brand</label>
                    <select style="border:0;border-bottom: solid 0.5px #ccc;width: 100%;" id="idBrand" name="idBrand">
                        <option value="">--Pilih Brand--</option>
                        <?php 
                            foreach($show_brand as $br){
                        ?>
                ...
                <div class="form-group">
                    <label>Stok di bawah minimum</label>
                    <select style="border:0;border-bottom: solid 0.5px #ccc;width: 100%;" id="stokMinim" name="stokMinim">
                        <option value="">--Semua Kondisi--</option>
                        <option value="3">Hanya stok di bawah minimum</option>
                    </select>
                </div>
