<!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            var voucer        = "<?php echo base_url('Voucergenerate/data_voucer'); ?>";
            $('#data-voucer').load(voucer);

            var vouceritem        = "<?php echo base_url('Voucergenerate/data_voucer_item/'.$id); ?>";
            $('#data-voucer-item').load(vouceritem);
