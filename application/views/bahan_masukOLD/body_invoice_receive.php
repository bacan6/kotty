                	...
                	<div class="col-md-12">
                        ...
                        <table style="margin-top: 5px;width: 100%;border:solid 1px black;font-size: 12px;">
                            <tr style="font-weight: bold;border-bottom: solid 1px black;">
                                ...
                                <td width="8%" style="text-align: center;border-right: solid 1px black;">B.</td>
                            ...
                            <?php $i++; } ?>
                            <tr>
                                <td colspan="7" align="right" style="border-right: solid 1px black;border-top: solid 1px black;padding-right: 5px">
                                    <b>S U B T O T A L</b>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="right" style="border-top: solid 1px black;padding-right: 5px">
                                    <b><?php echo number_format($total-$diskon,'2',',','.'); ?></b>
                                </td>
                            </tr>
                        </table>       
