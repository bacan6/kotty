 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            var urlCartPO = "<?php echo base_url('promo_buy1get3/cartPO'); ?>";
            ...
            $('#sku').change(function(){
               ...
               var group_series = $('#group_series').val();

               var urlInsertCartPo = "<?php echo base_url('promo_buy1get3/insertCartPO'); ?>";

               $.ajax({
                            method      : 'POST',
                            url         : urlInsertCartPo,
                            data        : {idProduk : idProduk, group_series : group_series},
            ...
            function submitPO(){
                ...
                var jumlah_gratis = $('#jumlah_gratis').val();
                ...
                var urlInsertPO = "<?php echo base_url('promo_buy1get3/insertPO'); ?>";
                ...
                if(tanggalMulai=='' || tanggalSelesai==''){
                    ...
                    $.ajax({
                                method      : "POST",
                                url         : urlInsertPO,
                                data        : {jumlah_bayar:jumlah_bayar,jumlah_gratis:jumlah_gratis,discount_percent:discount_percent,discount_rp:discount_rp,store:store,tanggalMulai : tanggalMulai, tanggalSelesai : tanggalSelesai, keterangan : keterangan, jamMulai : jamMulai, jamSelesai : jamSelesai, setJam : setJam,setHari : setHari,HariID : HariID},
                                beforeSend  : function(){
                                                $('#prosesPO').text('Harap Tunggu...');
                                                $('#CssLoader').show(); 
                                              },
                                success     : function(noInv){
                                                window.location.replace("<?php echo base_url('promo_buy1get3/form_promo?no_promo='); ?>"+noInv);
                                              }
                    });
                }
            }
            ...
            $('#sku').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('promo_buy1get3/ajax_produk'); ?>',
                    dataType    : 'json',
                    quietMillis : 100,
                    method      : "GET",
