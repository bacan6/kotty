 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            $('#viewReport').on("click",function(){
                ...
                var urlLaporanMutasi = "<?php echo base_url('laporan/viewReportReturPenjualan'); ?>";

                $.ajax({
                            method : "POST",
                            url : urlLaporanMutasi,
                            data : {dateStart : dateStart, dateEnd : dateEnd, idProduk : idProduk,noInvoice : noInvoice,store:store},
                            beforeSend : function(){
