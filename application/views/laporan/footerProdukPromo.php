 <!-- Page Content Ends -->
	...
	$('#produk-ajax').select2({
            ...
            function hapusPromo(id){
                var urlHapus = "<?php echo base_url('laporan/hapusProdukPromo'); ?>";
            ...
            $('#viewReport').on("click",function(){
                ...
                var urlLaporan = "<?php echo base_url('laporan/viewReportProdukPromo'); ?>";

                $.ajax({
                            method : "POST",
                            url : urlLaporan,
                            data : {dateStart : dateStart, dateEnd : dateEnd, store : store,tempat : tempat, kategori : kategori, subkategori : subkategori, subkategori2 : subkategori2, id_supplier:id_supplier,id_brand: id_brand,id_produk:idProduk},
                            beforeSend : function(){
