<?php
                    ...
                    ?>
                      ...
                      <h3 style="text-align: center;">Laporan Penjualan Perkategori Customer</h3>
                      <h3 style="text-align: center;"><?php echo $nama_kategori; ?></h3>
                    ...
                    <table class="table table-striped" style="font-size:11px;">
                      ...
                      <?php
                        ...
                        $grand_total   = 0;
                        $diskon_peritem = 0;
                        foreach($penjualan_perkategori_customer->result() as $row){
                      ?>
