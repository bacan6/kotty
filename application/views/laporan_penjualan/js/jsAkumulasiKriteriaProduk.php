        ...
        $.ajax({
                    ...
                    success : function(status){
                                if(status==0){
                                    ...
                                    $.ajax({
                                                method      : "POST",
                                                data        : {dateStart : dateStart, dateEnd : dateEnd, timeStart : timeStart, timeEnd : timeEnd, toko : toko, tempat : tempat, customer : customer, kategori : kategori, subkategori : subkategori, subkategori2 : subkategori2, id_supplier:id_supplier,id_brand: id_brand},
                                                url         : url,
                                                beforeSend  : function(){
