<script type="text/javascript">
    ...
    $('#viewReport').on("click",function(){
    	...
    	var url = "<?php echo base_url('laporan/laporanTopBrand'); ?>";
        ...
        $.ajax({
                    ...
                    success : function(status){
                                if(status==0){
                                    ...
                                    $.ajax({
                                                method      : "POST",
                                                data        : {dateStart : dateStart, dateEnd : dateEnd, toko : toko, kategori : kategori, subkategori : subkategori, subkategori2 : subkategori2},
                                                url         : url,
                                                beforeSend  : function(){
