...
<div class="wraper container-fluid">
  <div class="page-title"> 
      <h3 class="title"><i class="fa fa-ticket"></i> Data Voucer Belanja</h3> 
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <input type="text" name="tgl_mulai" class="form-control datetimepicker" placeholder="Tanggal Berlaku" id="tgl_mulai"/>
        </div>
        <div class="form-group">
          <input type="text" name="tgl_selesai" class="form-control datetimepicker" placeholder="Tanggal Expired" id="tgl_selesai"/>
        </div>
        <div class="form-group">
          <input type="text" name="quota" class="form-control" placeholder="Quota" id="quota"/>
        </div>
        <div class="form-group">
          <input type="text" name="nominal" class="form-control" placeholder="Nominal" id="nominal"/>
        </div>
        <div class="form-group">
          <input type="text" name="poin" class="form-control" placeholder="Poin" id="poin"/>
        </div>
        <div class="form-group">
