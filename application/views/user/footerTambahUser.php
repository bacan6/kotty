 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
        	...
        	$('.simpanUser').on("click",function(){
        		var urlTambahUser = "<?php echo base_url('setting/tambah_user_sql'); ?>";
                ...
                if(namaDepan=='' || namaBelakang=='' || email=='' || username=='' || password==''){
                    if(namaDepan==''){
            		...
            		$.ajax({
            					method : "POST",
            					url : urlTambahUser,
            					data : {namaDepan : namaDepan, is_admin:is_admin, namaBelakang : namaBelakang, noHP : noHP, email : email, username : username, password : password, menu : JSON.stringify(menu), submenu : JSON.stringify(submenu), toko : toko},
            					success : function(){
