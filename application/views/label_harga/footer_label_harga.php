 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            var urlCartPO = "<?php echo base_url('label_harga/cartLH'); ?>";
...
/*
                $('#supplier').change(function(){
                	...
                	$.ajax({
                                method      : "POST",
                                url         : '<?php echo base_url('label_harga/ajax_produk_supplier'); ?>',
            ...
            $('#sku').change(function(){
               ...
               var urlInsertCartPo = "<?php echo base_url('label_harga/insertCartPO'); ?>";
            ...
            function submitPO(){
                ...
                var urlInsertPO = "<?php echo base_url('label_harga/insertPO'); ?>";
                    ...
                    $.ajax({
                                ...
                                success     : function(noInv){
                                                window.location.replace("<?php echo base_url('label_harga/form_po?no_po='); ?>"+noInv);
                                              }
                    });
            ...
            $('#sku').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('label_harga/ajax_produk'); ?>',
                    dataType    : 'json',
                    quietMillis : 100,
                    method      : "GET",
