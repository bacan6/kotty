            ...
            <div class="portlet-body">
            	<div class="row">
            		<div class="col-md-12" style="text-align: right;font-size:15px;"> 
						<a href="<?php echo base_url('label_harga/importLabel'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Import Data Label</a>
            			<a href="<?php echo base_url('label_harga/daftar_po'); ?>"><i class="fa fa-book"></i> Daftar Label</a>
            		</div>
            	</div>
