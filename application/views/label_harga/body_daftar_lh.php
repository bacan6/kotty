<div class="wraper container-fluid">
    <div class="page-title"> 
      <h3 class="title">Daftar Label Harga</h3> 
    </div>
                        ...
                        <table class="table table-bordered" style="font-size:12px;" id="datatable">  
                           <thead>
                               <tr style="font-weight: bold;">
                                    ...
                                    <td style="text-align: center;vertical-align: middle;" width="18%">No Pelabelan</td>
                                    ...
                                    <td style="text-align: center;vertical-align: middle;" width="15%">Aksi</td> 
                               </tr>
